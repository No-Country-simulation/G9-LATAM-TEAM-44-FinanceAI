...
Muestra de **60 errores** (de 38,129 errores totales sobre 63,309 filas entrenables evaluadas OOF, CV agrupada por comercio, Fase 2), estratificada por categoria real y por nivel de confianza (`prob_max`) para cubrir variedad en vez de tomar solo los primeros N por indice.

## Distribucion de causas probables

| causa_probable | n errores en la muestra | % de la muestra |
|---|---|---|
| comercio_desconocido_en_vocabulario | 43 | 71.7% |
| categoria_ambigua | 16 | 26.7% |
| texto_insuficiente | 0 | 0.0% |
| keyword_compartido_entre_categorias | 1 | 1.7% |
...
### comercio_desconocido_en_vocabulario (43 casos en la muestra)
...
### categoria_ambigua (16 casos en la muestra)
...
### texto_insuficiente (0 casos en la muestra)
...
### keyword_compartido_entre_categorias (1 casos en la muestra)
